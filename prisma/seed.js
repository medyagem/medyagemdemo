  ...
  for (const s of services) {
    await prisma.service.upsert({
      ...
      update: {
        ...
        cover_image_alt: s.cover_image_alt || s.name,
  ...
  for (const r of regions) {
    await prisma.region.upsert({
      ...
      update: {
        ...
        cover_image_alt: r.cover_image_alt || r.name,
        intro_title: r.intro_title,
        overview_content: r.overview_content,
      },
      create: {
        id: r.id.includes('demo') ? undefined : r.id,
        name: r.name,
        slug: r.slug,
        short_description: r.short_description,
        hero_title: r.hero_title,
